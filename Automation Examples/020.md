...
After running the above script and seeing the webpage, you can inspect the "Fun & Strange Stuff" element and in the developer tools, right click it and choose "Copy Xpath" that you can insert in the search argument for selenium.click command.
